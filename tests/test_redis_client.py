...
class TestReadConfig:
    """The None-on-failure reader. get_config answers all-unset for both a guild
    that never chose and a read that failed; a caller that caches the answer
    needs them apart."""
...
class TestReadConfigWriters:
    """read_guild_configs' omission contract, over the writer stamp."""
