...
def pytest_collection_modifyitems(
    ...
    ASSERTED that any pg test actually ran, and three invariants are covered
    ONLY here (ON CONFLICT dedup, the -history tie-break, and insert_batch's
    call to _sanitize_entry). A tier that silently stops running is worse than
