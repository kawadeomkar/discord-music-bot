...
class TestExtractionPool:
    ...
    The autouse conftest fixture pins src.youtube._YTDLP_POOL to an in-process
    ...
    def _swap_pool(self, value: Optional[Executor]) -> Optional[Executor]:
    ...
    def test_get_pool_lazily_creates_one_process_pool(self) -> None:
        import src.youtube as youtube
    ...
    def test_prewarm_is_noop_for_thread_pool(self) -> None:
        import src.youtube as youtube
    ...
    def test_shutdown_joins_and_clears_the_pool(self) -> None:
        import src.youtube as youtube
        ...
        try:
            ...
            # Restore the fixture's thread pool — leaving it None would make the next
            # _get_pool() in this worker build a real ProcessPoolExecutor and break
            # tests that submit an unpicklable MagicMock extractor.
            self._swap_pool(previous)

    def test_shutdown_is_safe_when_no_pool_exists(self) -> None:
        previous = self._swap_pool(None)
        try:
            import src.youtube as youtube
    ...
    async def test_run_extract_heals_a_broken_pool_and_retries_once(self) -> None:
    ...
    async def test_run_extract_propagates_a_second_broken_pool(self) -> None:
