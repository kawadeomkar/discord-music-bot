...
class YTDL(discord.FFmpegOpusAudio):
    ...
    def __init__(
        ...
        *,
        ...
        # Carried for that rebuild, and read by the playback loop to decide whether
        # settling its claim LPOPs: a crash-recovered head that came back True would
        # retire an entry that was never its own.
