...
# Touched by a loop-resident task so the container HEALTHCHECK can tell a
# wedged event loop from a healthy one. Unset (the default outside Docker)
# disables the task entirely — nothing reads the file there.
